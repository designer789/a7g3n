...
/**
 * Hero Component - Main showcase section of the website
 * 
 * Features welcome message, main heading, descriptive text, and social links
 * Uses a blue gradient background for visual effect
 * 
 * @param className - Optional CSS class name for additional styling
 */
export function Hero({ className = '' }: HeroProps) {
  return (
    <section className={`min-h-screen bg-black text-white relative ${className}`}>
      {/* Radial gradient background overlay */}
      <div className="absolute inset-0 pointer-events-none" style={{ 
        background: 'radial-gradient(140% 107.13% at 50% 10%, transparent 37.41%, #0066ff 69.27%, #fff 100%)'
      }}></div>

      {/* Content Wrapper */}
      <div className="relative z-10 w-full min-h-screen flex items-center">
        <div className="container max-w-8xl mx-auto px-4 md:px-6 py-12 md:py-20">
          {/* Content Grid */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="relative z-20 space-y-6 md:space-y-8 text-center lg:text-left">
              ...
              <div className="inline-block">
                <span className="inline-flex items-center px-4 py-2 rounded-full bg-blue-600/30 text-blue-300 border border-blue-500/50 font-[family-name:var(--font-aldrich)] text-sm md:text-base leading-none">
                  Welcome to A7G3N
                </span>
              </div>
              ...
              {/* Main heading */}
              <h1>
                <span className="block text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-medium tracking-tighter leading-tight font-[family-name:var(--font-aldrich)] bg-gradient-to-b from-blue-50 to-blue-500 text-transparent bg-clip-text">
              ...
              <p className="text-base sm:text-lg md:text-xl text-gray-300 leading-relaxed max-w-xl mx-auto lg:mx-0">
                Autonomous, cross-chain AI agents that evolve and act on-chain.
                Seamless strategies. Real-time adaptation. Community-driven intelligence.
              </p>
              
              {/* Social Links */}
              <div className="flex flex-wrap gap-6 justify-center lg:justify-start pt-6 md:pt-10">
            ...
            {/* Right visual section - Image Container */}
            <div className="relative lg:absolute lg:top-0 lg:right-[10%] lg:w-[45%] h-[300px] sm:h-[400px] md:h-[500px] lg:h-full">
              <div className="absolute inset-0">
                ...
                <div className="relative w-full h-full">
                  <Image
                    ...
                    alt="A7G3N Hero"
                    fill
                    className="object-contain p-4 md:p-8 lg:p-0"
                    priority
